	...
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Application Form </h2>
			<div class="mail_grid_w3l">
				<form action="application_form_action.php" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							<div class="contact-fields-w3ls">
								<input type="text" name="fname" placeholder="Name" value="<?php echo $_SESSION['fname'];?>" >
							</div>
							<div class="contact-fields-w3ls">
								<input type="text" name="email" placeholder="" value="<?php echo $_SESSION['email']?>" >
							</div>
							<div class="contact-fields-w3ls">
								<input type="text" name="hostel" placeholder="Hostel" value="<?php echo $_GET['id']?>" required="" >
							</div>
							<div class="contact-fields-w3ls">
