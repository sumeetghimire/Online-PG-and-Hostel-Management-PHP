...
<?php
    ...
    $query = "SELECT * FROM admin_message WHERE fname ='$fname'";
    ...
    <div class="container">
      ...
      <div class="card-footer"><?php echo "PGs Manager"; ?><span style="float: right"><?php echo $row['msg_date']." ".$row['msg_time']; ?></span></div>
  </div>
</div>
<br><br>
