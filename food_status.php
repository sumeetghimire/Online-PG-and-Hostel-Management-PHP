		...
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					...
					<a class="nav-link" href="payment_info.php">Payment Status</a>
...
<?php
    ...
    {  
    	$hostel = $row['hostel'];
    	$query6 = "SELECT * FROM application WHERE hostel = '$hostel'";
...
<br>
<?php
        $check = $_SESSION['fname'];
        $query2 = "SELECT * FROM food WHERE fname ='$check'";
        $result = mysqli_query($conn, $query2);
        $num = mysqli_fetch_row($result);
        if($num==false)
        {
            ?>
        <p style="color:black;font-size:30px;text-align:center;font-weight:bold">You have not Subscribed any food </p> 
         <?php
        }
        else
        {
      ?>
          <?php include('fetch_food_data.php')?>
