...
<div class="inner-page-banner" id="home"> 	   
	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home.php">Payment Portal <span class="display"></span></a></h1>
    ...
    {  
    	$hostel_id = $row['fname'];
    	$query6 = "SELECT * FROM application WHERE fname = '$hostel_id'";
	...
	<div class="container">
		...
		<h2 class="heading text-capitalize mb-sm-5 mb-4"></h2>
			<div class="mail_grid_w3l">
				<form action="payment_form_action.php" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							<div class="contact-fields-w3ls">
								...
								<p style="color:red;font-size:25px;font-weight: bold">Amount Paid By
									<br>
									<input type="text" name="fname" placeholder="Fullname" required="" readonly value=<?php echo $_SESSION['fname']; ?>>
								</p>
							</div>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="#" target="_blank">Own Your Rent<span class="display"> CALICUT</span></a>
		</div>
