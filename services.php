				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active">
							<a class="nav-link" href="services.php">PGs</a>
						</li>
...
<section class="services py-5">
	<div class="container py-lg-5 py-3">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> PGs </h2>
		<div class="row service-grids">
			<div class="col-lg-4 col-md-6 service-grid1">
				<a href="application_form.php"><h3>Single Room</h3></a>
				<div class="row">
				...
				<div class="row wthree_banner_bottom_right_grids pr-sm-3">
					<div class="col-lg-3 col-sm-6 banner_bottom_right_grid">
						<div class="view view-tenth">
							<div class="agile_text_box">
								...
								<h3> Apply for Single Sharing </h3>
								<p> </p>
								<br>
									<p>1 yr</p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=Single"><img src="web_home/images/single1.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for Double Sharing </h3>
								<p></p>
								<p>1 yr</p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=Double"><img src="web_home/images/single2.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for Triple  Sharing</h3>
								<p>1 Year</p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=Triple"><img src="web_home/images/triple1.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
										</div>
				...
				<div class="row wthree_banner_bottom_right_grids pr-sm-3">
					...
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							...
							<div class="mask">
								<a href="food_application.php?id=veg-food"><img src="web_home/images/veg.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							...
							<div class="mask">
								<a href="food_application.php?id=non-veg-food"><img src="web_home/images/nonveg.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
