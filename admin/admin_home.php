...
if (!isset($_SESSION['Username'])) 
{
    ...
    echo "<script>alert('Please login to get into the page')</script>";
} 
...
<html lang="en">
<head>
<title>Own Your Rent|Home</title>
...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="admin_home.php">Own Your Rent<span class="display"></span></a></h1>
          ...
          <li class="nav-item">
					...
					<li class="nav-item">
						<a class="nav-link" href="students.php">List of Students</a>
					</li>
						<li class="nav-item">
						<a class="nav-link" href="message_student.php">Student messages</a>
					</li>
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="images/img7.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li class="next-slide">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-2)" xlink:href="images/img9.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
							<div class="text-center">
								<h3>Rooms Allocation</h3>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://www.nitc.ac.in/" target="_blank">Own Your Rent<span class="display"></span></a>
		</div>
		<div class="footer-grid">
			...
			<div class="list-footer">
				<ul class="footer-nav text-center">
					...
					<li>
						<a href="message_student.php">Student Messages</a>
					</li>
					<li>
