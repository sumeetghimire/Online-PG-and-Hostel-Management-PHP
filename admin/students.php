...
<?php
   if (isset($_POST['search'])) {
   	   ...
   	   $query_search = "SELECT * FROM Student WHERE fname like '$search_box%'";
    ...
    <?php
   	   if(mysqli_num_rows($result_search)==0){
            ...
            $student_name = $row_search['Fname']." ".$row_search['Lname'];
      		...
      		echo "<tr><td>{$student_name}</td><td>{$row_search['email']}</td><td>{$row_search['Mob_no']}</td><td>{$hostel_name}</td><td>{$room_no}</td></tr>\n";
   	   }
   }
   ?>
   </tbody>
         ...
         echo '<tr><td colspan="4">No Rows Returned</td></tr>';
      	...
      	while($row1 = mysqli_fetch_assoc($result1)){
            ...
            $student_name = $row1['Fname']." ".$row1['Lname'];
      		...
      		echo "<tr><td>{$student_name}</td><td>{$row1['email']}</td><td>{$row1['Mob_no']}</td><td>{$HNM}</td><td>{$room_no}</td></tr>\n";
      	}
      }
    ?>
    </tbody>
