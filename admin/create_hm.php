			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="create_hm.php">Appoint Manger</a>
						</li>
						<li class="nav-item">
...
<br><br><br><br><br>
	<div class="main">
        ...
        <fieldset class="step w3_agileits">
          <legend>Appoint PG Manager</legend>
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="../includes/hm_signup.php" method="POST">
                  ...
                  <input type="text" name="hostel_name" placeholder="PG  NAME" required="required">
                  <input type="email" name="Email" placeholder="EMAIL" required="required">
                  <input type="password" name="pass" placeholder="PG MANAGER'S PASSWORD" required="required">
                  <input type="password" name="confpass" placeholder="CONFIRM PG MANAGER'S PASSWORD" required="required">
              ...
              <div class="clear"></div>
				...
				<fieldset class="step w3_agileits">
          <legend>Remove PG Manager</legend>
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
